...
def preprocess(file):
    pos=np.loadtxt(file,dtype=type(str),delimiter=',')
    pos=pos[1:]
...
pos_a,pos_data=preprocess('data2/numpy_input_HP_pos.csv')
neg_a,neg_data=preprocess('data2/numpy_input_HP_neg.csv')
